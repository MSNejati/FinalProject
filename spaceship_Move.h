...
bool our_spaceship_v_initialize(float *our_spaceship_right_v, float *our_spaceship_left_v) {
    ...
    if (SDL_PollEvent(&our_spaceship_move)) {
        ...
        *our_spaceship_left_v = 0;
        ...
        if (our_spaceship_move.type == SDL_QUIT) {
            return false;
        }
    }
    return  true;
...
void our_spaceship_move(int *our_spaceshipx, float *our_spaceship_right_v, float *our_spaceship_left_v, int screenwidth,
                        int screenheight) {
